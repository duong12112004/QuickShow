...
const MovieDetails = () => {
  ...
  // API lấy thông tin chi tiết phim và lịch chiếu tương ứng
  const getShow = async () => {
    try {
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center gap-2 text-gray-300'>
            ...
            {/* Chống sập web nếu phim chưa có điểm đánh giá */}
            {show.movie.vote_average ? show.movie.vote_average.toFixed(1) : "0.0"} Điểm đánh giá
          </div>
